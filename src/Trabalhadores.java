...
public class Trabalhadores extends Agent {
	private static final long serialVersionUID = 1L;
	
	// construtor do behaviour
	class TrabalhadoresBehavior extends SimpleBehaviour {
		private static final long serialVersionUID = 1L;


		// construtor do behaviour
		public TrabalhadoresBehavior(Agent a) {
			super(a);
		}
		...
		protected void setup() {
			...
			TrabalhadoresBehavior b = new TrabalhadoresBehavior(this);
			addBehaviour(b);
